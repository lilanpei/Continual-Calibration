...
nohup python main.py -v 1 --cuda_id 1 --logdir ./logs/F_EuroSAT4 -ts 256 -es 256 -tp 200 -lr 0.001 -ep -p 10 -dn EuroSAT -sn JointTraining > jointe_1.log 2>&1 &
nohup python main.py -v 2 --cuda_id 1 --logdir ./logs/F_EuroSAT4 -ts 256 -es 256 -tp 200 -lr 0.001 -ep -p 10 -dn EuroSAT -sn JointTraining > jointe_2.log 2>&1 &
nohup python main.py -v 3 --cuda_id 2 --logdir ./logs/F_EuroSAT4 -ts 256 -es 256 -tp 200 -lr 0.001 -ep -p 10 -dn EuroSAT -sn JointTraining > jointe_3.log 2>&1 &
nohup python main.py -v 1 --cuda_id 2 --logdir ./logs/F_EuroSAT4 -ts 256 -es 256 -tp 200 -lr 0.001 -ep -p 10 -dn EuroSAT -sn JointTraining -stcm --ent_weight 0.05 > jointe_st1.log 2>&1 &
nohup python main.py -v 2 --cuda_id 3 --logdir ./logs/F_EuroSAT4 -ts 256 -es 256 -tp 200 -lr 0.001 -ep -p 10 -dn EuroSAT -sn JointTraining -stcm --ent_weight 0.05 > jointe_st2.log 2>&1 &
nohup python main.py -v 3 --cuda_id 3 --logdir ./logs/F_EuroSAT4 -ts 256 -es 256 -tp 200 -lr 0.001 -ep -p 10 -dn EuroSAT -sn JointTraining -stcm --ent_weight 0.05 > jointe_st3.log 2>&1 &
