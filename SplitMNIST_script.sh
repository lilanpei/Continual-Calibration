...
nohup python main.py -v 1 -cid 2 -sn "DER" -dn "SplitMNIST" -tp 20 --logdir "./logs/SplitMNIST_D_ST" -ms 2000 -a 0.3 -b 0.8 -bsm 32 -stcm --ent_weight 0.005 > md.log 2>&1 &
nohup python main.py -v 2 -cid 2 -sn "DER" -dn "SplitMNIST" -tp 20 --logdir "./logs/SplitMNIST_D_ST" -ms 2000 -a 0.3 -b 0.8 -bsm 32 -stcm --ent_weight 0.005 > md2.log 2>&1 &
nohup python main.py -v 3 -cid 2 -sn "DER" -dn "SplitMNIST" -tp 20 --logdir "./logs/SplitMNIST_D_ST" -ms 2000 -a 0.3 -b 0.8 -bsm 32 -stcm --ent_weight 0.005 > md3.log 2>&1 &
